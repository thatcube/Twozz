...
struct PlayerView: View {
  ...
  /// live that catching up isn't worth a rebuffer; anything longer means the
  /// viewer came back that far behind the broadcast.
  let liveResumeCatchUpSeconds: Double = 5
