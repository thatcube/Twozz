...
struct SettingsAboutSection: View {
  ...
  private static let repoURL = "https://github.com/thatcube/Twozz"
  ...
  var body: some View {
    HStack(alignment: .top, spacing: 32) {
      VStack(alignment: .leading, spacing: 16) {
        ...
        Text("Twozz is free and open source. It's an unofficial Twitch client for Apple TV, not affiliated with or endorsed by Twitch.")
          .font(.callout)
